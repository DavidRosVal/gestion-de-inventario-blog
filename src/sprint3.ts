...
export const SPRINT3= [
  ...
  {
    slug: 'demostrar-y-validar-sprint',
    data: {
      heroImage: '',
      title: 'Demostrar y validar Sprint',
    }
  },
  {
    slug: 'retrospectiva-del-sprint',
    data: {
      heroImage: '',
  ...
  {
    slug: 'retrospectiva-del-proyecto',
    data: {
      heroImage: '',
